...
module.exports = {
  ...
  env: {
    ...
    REACT_AWS_SECRET_ACCESS_KEY: process.env.AWS_SECRET_ACCESS_KEY || process.env.REACT_AWS_SECRET_ACCESS_KEY,
    AWS_SECRET_ACCESS_KEY: process.env.AWS_SECRET_ACCESS_KEY || process.env.REACT_AWS_SECRET_ACCESS_KEY,
