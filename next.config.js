...
module.exports = {
  ...
  env: {
    ...
    REACT_AWS_REGION: process.env.AWS_REGION || process.env.REACT_AWS_REGION,
    REACT_AWS_ACCESS_KEY_ID: process.env.AWS_ACCESS_KEY_ID || process.env.REACT_AWS_ACCESS_KEY_ID,
    REACT_AWS_SECRET_ACCESS_KEY: process.env.AWS_SECRET_ACCESS_KEY || env.REACT_AWS_SECRET_ACCESS_KEY,
    AWS_SECRET_ACCESS_KEY: process.env.AWS_SECRET_ACCESS_KEY || env.REACT_AWS_SECRET_ACCESS_KEY,
    AWS_COGNITO_CLIENT_ID: process.env.AWS_COGNITO_CLIENT_ID || process.env.REACT_APP_AWS_COGNITO_CLIENT_ID,
    AWS_COGNITO_USER_POOL_ID: process.env.AWS_COGNITO_USER_POOL_ID || process.env.REACT_AWS_COGNITO_POOL_ID,
    REACT_AWS_BUCKET_NAME: process.env.AWS_BUCKET_NAME || process.env.REACT_AWS_BUCKET_NAME,

    REACT_AWS_DYNAMODB_URL: process.env.REACT_AWS_DYNAMODB_URL,

    STRIPE_SECRET_KEY: process.env.STRIPE_SECRET_KEY || process.env.REACT_STRIPE_WEBHOOK_SECRET,
    STRIPE_WEBHOOK_SECRET: process.env.STRIPE_WEBHOOK_SECRET || process.env.REACT_STRIPE_WEBHOOK_SECRET,
    REACT_STRIPE_SECRET_KEY: process.env.STRIPE_SECRET_KEY || process.env.REACT_STRIPE_WEBHOOK_SECRET,
    REACT_STRIPE_WEBHOOK_SECRET: process.env.STRIPE_WEBHOOK_SECRET || process.env.REACT_STRIPE_WEBHOOK_SECRET,
