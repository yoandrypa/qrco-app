...
import RenderQrListOptions from "./RenderQrListOptions";
                  ...
                  {!isWide && (<Box sx={{ display: 'grid', textAlign: 'right' }}>
                    ...
                    <Box sx={{ display: 'grid', mr: '10px' }}>
                      ...
                      <Typography variant="caption"
                                  style={{ color: "#808080" }}>{pluralize('visit', qrLink.visitCount || 0, true)}</Typography>
                    </Box>
                  </Box>)}
                  {isWide && (
                  ...
                  {isWide && (
                    <Box sx={{ display: "flex", justifyContent: "space-between", width: { sm: '100px', md: '220px' } }}>
                      {qr.isDynamic ? (
                        <Stack direction="column" spacing={1} justifyContent="flex-start" alignItems="center"
                          ...
                          <Typography variant="h4"
                                      sx={{ color: qrLink.visitCount > 0 ? "blue" : MAIN_ORANGE, mb: '-12px' }}>
                            {qrLink.visitCount || 0}
                          </Typography>
                          <Typography variant="caption" sx={{ color: '#808080' }}>
                      ...
                      <RenderQrListOptions
                        ...
                        link={qr.isDynamic ? qrLink.link : undefined} />
                    </Box>
                  )}
                </Stack>
              </Paper>
