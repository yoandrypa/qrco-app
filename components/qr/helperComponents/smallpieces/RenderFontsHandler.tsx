...
export default function RenderFontsHandler({data, handleValue}: RenderFontsHandlerProps) {
  ...
  const renderFontType = useCallback((font: FontTypes) => ( // @ts-ignore
    ...
    <>
      ...
      <Paper elevation={2} sx={{p: 1, mt: 1}}>
        ...
        {expander === 'custom' && (<>
          ...
          <Typography sx={{fontWeight: 'bold', mb: '5px', mt: '10px'}}>{'Titles'}</Typography>
          ...
          <Typography sx={{fontWeight: 'bold', mb: '5px', mt: '10px'}}>{'Sub titles'}</Typography>
          <Grid container spacing={2}>
            <Grid item xs={isWide ? 4 : 12}>
          ...
          <Typography sx={{fontWeight: 'bold', mb: '5px', mt: '10px'}}>{'Messages'}</Typography>
          <Grid container spacing={2}>
            <Grid item xs={isWide ? 4 : 12}>
          ...
          <Typography sx={{fontWeight: 'bold', mb: '5px', mt: '10px'}}>{'Buttons'}</Typography>
